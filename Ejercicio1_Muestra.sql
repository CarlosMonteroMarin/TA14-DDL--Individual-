...
--
-- Host: 192.168.1.139    Database: Ejercicio1
-- ------------------------------------------------------
...
CREATE TABLE `Muestra` (
  ...
  `humedad_minima` int DEFAULT NULL,
  `humedad_maxima` int DEFAULT NULL,
  `velocidad_viento_minima` int DEFAULT NULL,
  `velocidad_viento_maxima` int DEFAULT NULL,
